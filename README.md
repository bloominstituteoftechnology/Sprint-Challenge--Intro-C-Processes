...
task fork - a new process is made and is ready to be executed
task running - a process is being executed by the CPU
task terminated - a process is finished being executed
task interruptable - process is sleeping
task uninterruptable - process waits for something without being interrupted

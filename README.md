...
3. What are some of the benefits of working in a compiled language versus a non-compiled language? More specifically, what benefits are there to be had from taking the extra time to compile our code?
  ...
  Compiled languages are usually more efficient than interpreted languages because compiled languages only need to be translated once, when they are compiled. Interpreted languages must be parsed and interpreted multiple times for multiple executions. Compiling code also allows for more optimizations during the compile stage.

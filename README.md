...
Running -- The process has be assigned and is running.

Waiting --- The process has been paused because system resources need to work on something else.

Exit -- The process is done or has stopped because of an error.
   

2. What is a zombie process? How does one get created? How does one get destroyed?

A zombie process is a process that has completed it's job but is still listed in the process table.

Linux has a service the cleans these up

3. What are some of the benefits of working in a compiled language versus a non-compiled language? More specifically, what benefits are there to be had from taking the extra time to compile our code?

Compiled languages run faster, they is not VM between the OS and application like in Java or C#.

You have better type check
